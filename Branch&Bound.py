...
def main(a, b, c, z=time.time()):
    ...
    tracemalloc.start()  # Memulai pemantauan memori sebelum eksekusi algoritma utama
    # Me-reset pemantauan memori
    X = BB(F, S, C)
    ...
    tracemalloc.stop()  # Menghentikan pemantauan memori setelah eksekusi algoritma utama
